...
# kubectl apply -f samples/bookinfo/platform/kube/bookinfo-mysql.yaml # Aplicações pod que vem por padrão para testar o istio
...
kubectl port-forward deploy/jaeger 16686:16686 -n istio-system --address 0.0.0.0 # para expor para qualqur IP
